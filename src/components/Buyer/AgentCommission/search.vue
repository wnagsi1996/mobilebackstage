	...
	<div>
		...
		<div class="search-info">
			<van-form>
				...
				<van-cell-group>
					<van-field readonly clickable right-icon="arrow-down" name="datetimePicker" 
					:value="fromorder.lpdate1" label="开始时间" placeholder="留评开始时间" @click="showdate(7)"/>
				</van-cell-group>
				<van-cell-group>
					<van-field readonly clickable right-icon="arrow-down" name="datetimePicker" 
					:value="fromorder.lpdate2" label="结束时间" placeholder="留评结束时间" @click="showdate(8)"/>
				</van-cell-group>
			</van-form>
