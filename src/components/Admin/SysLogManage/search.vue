	...
	<div>
		...
		<div class="search-info">
			<van-form>
				...
				<van-cell-group>
					<van-field v-model.trim="fromorder.keyword" label="关键字" placeholder="关键字" />
				</van-cell-group>
				<van-cell-group>
					<van-field readonly clickable right-icon="arrow-down" name="picker" 
					:value="fromorder.name.text" label="操作人员" placeholder="操作人员" @click="showPickerList(1)"/>
				</van-cell-group>
				<van-cell-group>
